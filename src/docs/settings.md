...
Click the global usage footer to open usage history with project, environment, CLI, model and date filters, a period comparison, daily trend and expandable session ledger. See [Usage & Quota](usage-quota.md#usage-history-dialog).
