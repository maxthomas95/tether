export const IPC = {
  ...
  SESSION_SET_HELM_ENABLED: 'session:set-helm-enabled',
  ...
  GIT_PROVIDER_LIST_PROJECTS: 'git:provider-list-projects',
  GIT_PROVIDER_CREATE_REPO: 'git:provider-create-repo',
  GIT_CLONE: 'git:clone',
  GIT_INIT: 'git:init',
  GIT_CREATE_FOLDER: 'git:create-folder',
